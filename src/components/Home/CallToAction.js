    ...
    <div className="w-full h-fit mt-32 mb-36">
      ...
      <div className="flex md:flex-row flex-col justify-center items-center mt-2 ">
        {CONTENT.map((el, idx) => (
          <Link
            href={el.url}
            className="p-4 md:border group/text-hover border-zinc-400  first:rounded-tl-md first:rounded-bl-md last:rounded-tr-md last:rounded-br-md border-l-none first:border-l"
            key={idx}
          >
